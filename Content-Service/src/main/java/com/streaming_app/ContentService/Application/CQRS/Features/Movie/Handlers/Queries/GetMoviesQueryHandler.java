...
import com.streaming_app.ContentService.Application.CQRS.Features.Movie.Requests.Queries.GetMoviesQuery;
...
public class GetMoviesQueryHandler {
    ...
    public List<MovieResponseDto> handle(GetMoviesQuery request) {
